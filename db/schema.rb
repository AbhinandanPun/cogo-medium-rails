...
ActiveRecord::Schema[7.0].define(version: 2023_08_05_041337) do
  ...
  create_table "interaction_histories", force: :cascade do |t|
    ...
    t.index ["user_id", "post_id"], name: "index_interaction_histories_on_user_id_and_post_id", unique: true
  ...
  add_foreign_key "interaction_histories", "posts"
